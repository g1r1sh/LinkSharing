		...
		<div id="list-topic" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="dateUpdated" title="${message(code: 'topic.dateUpdated.label', default: 'Date Updated')}" />
				...
				<g:each in="${topicInstanceList}" status="i" var="topicInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:formatDate date="${topicInstance.dateUpdated}" /></td>
